...
class Palindrome {
    ...
    static boolean isPalindrome(String str) {
        ...
        // in this solution we are using two pointer approach to check if the string is
        // palindrome or not.
        // time complexity : O(n)
    ...
    static boolean isPalindrome2(String str) {
        ...
        // in this solution we are creating a new reversed string and comparing it with
        // the original string. This approach uses extra space for the reversed string.
        // time complexity : O(n)
