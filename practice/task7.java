...
class Main {
    public static void main(String[] args) {
     ...
     // in these case where no divisible array is given for any hint then our loop must go from 2 to n-1 because for a prime number valid factors are 1 and the number itself n and checking for n+1,... does not make any case sense cause their very first divible factor will be greater. like :
